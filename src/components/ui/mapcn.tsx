...
// mapcn — 21st.dev registry bileşeni (npx shadcn add ".../mapcn-marker-tooltip" kurulumunun karşılığı)
// MapLibre GL tabanlı tema duyarlı harita + özel marker + hover tooltip.
